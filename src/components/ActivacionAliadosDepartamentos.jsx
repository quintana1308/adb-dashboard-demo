...
const ActivacionAliadosDepartamentos = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      {/* Header */}
      <DashboardHeader title="Activación - Aliados Departamentos">
        ...
        <div className="flex items-center justify-between md:hidden">
          ...
          <div className="flex items-center space-x-2">
            <ActivacionExcelExportButton
              ...
              rpcFunction="get_act_aliados_departamentos_v2"
              columns={[
              ...
              filename="activacion_aliados_departamentos"
              title="Reporte de Activación - Aliados Departamentos"
            />
      ...
      <div className="p-4 sm:p-6 flex-1">
        ...
        <div className="lg:hidden mb-6">
          ...
          >
            Activación - Aliados Departamentos
          </h1>
        </div>
...
export default ActivacionAliadosDepartamentos
