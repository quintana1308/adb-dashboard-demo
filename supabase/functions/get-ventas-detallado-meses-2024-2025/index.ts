...
Deno.serve(async (req)=>{
  ...
  try {
    ...
    const { mes = 'All', aliado = 'All', sucursal = 'All', marca = 'All', rubro = 'All', portafolio_interno = 'All', consumo_masivo = 'All', version = 'All', presentacion = 'All', estado = 'All' } = requestBody;
    ...
    // Llamar a la función RPC con los parámetros correctos mapeados a las columnas reales
    const { data, error } = await supabase.rpc('get_ventas_detallado_meses_2024_2025', {
      p_mes: mes,
      p_aliado: aliado,
      p_sucursal: sucursal,
      p_marca: marca,
    ...
    console.log('Datos procesados:', data?.length || 0, 'meses');
