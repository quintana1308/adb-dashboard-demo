...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { mes, aliado, sucursal, marca, rubro, portafolio_interno, consumo_masivo, version, presentacion, region, sku, tipo_cliente } = body;
    ...
    const { data, error } = await supabaseClient.rpc('get_ventas_region_aliado_sku', {
