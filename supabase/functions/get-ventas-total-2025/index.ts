...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    console.log('Parámetros para get_ventas_total_2025:', params);
    ...
    console.log('Resultado get_ventas_total_2025:', data);
    ...
    console.error('Error en get-ventas-total-2025:', error);
    return new Response(
      JSON.stringify({ 
