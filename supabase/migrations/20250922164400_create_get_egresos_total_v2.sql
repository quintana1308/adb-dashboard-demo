-- Crear función corregida para obtener el total de gastos generales filtrado
-- Versión 2 con nombres de columnas correctos

CREATE OR REPLACE FUNCTION get_egresos_total_v2(
...
COMMENT ON FUNCTION get_egresos_total_v2 IS 'Función v2 para calcular el total de gastos generales con filtros aplicados - nombres de columnas corregidos';
