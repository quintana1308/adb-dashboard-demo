-- Corregir función duplicada get_ventas_region_aliado_sku
-- Eliminar ambas versiones existentes y crear la versión correcta con filtro tipo_cliente
...
-- Crear la función correcta basada en la migración 20250818071204 pero con filtro tipo_cliente
