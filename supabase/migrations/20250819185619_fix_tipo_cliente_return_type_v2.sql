-- Corregir el tipo de retorno de la función get_ventas_tipo_cliente_barras
-- para que coincida con el tipo de dato de la columna tipocliente
...
-- Crear la nueva función con el tipo de retorno correcto
...
RETURNS TABLE(
    "2024" numeric,
    "2025" numeric,
    "TIPOCLIENTE" character varying(50)  -- Cambiado de text a character varying(50)
)
LANGUAGE plpgsql
AS $$
BEGIN
