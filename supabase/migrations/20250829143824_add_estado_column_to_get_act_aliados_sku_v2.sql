-- Crear nueva función get_act_aliados_sku_v2 que incluye la columna estado
...
BEGIN
  ...
  WHERE h.tipo = 'SKU'
    ...
    AND (p_sku IS NULL OR p_sku = 'All' OR h.descri ILIKE '%' || p_sku || '%');
  ...
  RETURN QUERY EXECUTE format('
    ...
    WHERE h.tipo = $7
      ...
      AND ($6 IS NULL OR $6 = $15 OR h.descri ILIKE $8 || $6 || $9)
    ORDER BY %s
    LIMIT %L OFFSET %L',
    total_records, sum_a2024, sum_c2024, sum_a2025, sum_c2025, avg_prom2024, avg_prom2025, sort_clause, p_page_size, offset_val
  ) USING p_mes, p_region, p_estado, p_aliado, p_sucursal, p_sku, 'SKU', '%', '%', 'All', 'All', 'All', 'All', 'All', 'All';
END;
$_$;

-- Otorgar permisos a la nueva función
ALTER FUNCTION "public"."get_act_aliados_sku_v2"("p_mes" "text", "p_region" "text", "p_estado" "text", "p_aliado" "text", "p_sucursal" "text", "p_sku" "text", "p_page" integer, "p_page_size" integer, "p_sort_column" "text", "p_sort_direction" "text") OWNER TO "postgres";

GRANT ALL ON FUNCTION "public"."get_act_aliados_sku_v2"("p_mes" "text", "p_region" "text", "p_estado" "text", "p_aliado" "text", "p_sucursal" "text", "p_sku" "text", "p_page" integer, "p_page_size" integer, "p_sort_column" "text", "p_sort_direction" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."get_act_aliados_sku_v2"("p_mes" "text", "p_region" "text", "p_estado" "text", "p_aliado" "text", "p_sucursal" "text", "p_sku" "text", "p_page" integer, "p_page_size" integer, "p_sort_column" "text", "p_sort_direction" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_act_aliados_sku_v2"("p_mes" "text", "p_region" "text", "p_estado" "text", "p_aliado" "text", "p_sucursal" "text", "p_sku" "text", "p_page" integer, "p_page_size" integer, "p_sort_column" "text", "p_sort_direction" "text") TO "service_role";