-- Corregir función RPC para obtener datos de sincronización de ventas con nombres de columnas correctos
...
BEGIN
    ...
    -- Construir consulta dinámica con nombres de columnas correctos
    v_query := 'SELECT 
                h.aliadoid,
                h.aliado,
                h.sucursalid,
