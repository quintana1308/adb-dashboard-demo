-- Create new function get_act_aliados_grupos_v3 fixing missing columns
CREATE OR REPLACE FUNCTION "public"."get_act_aliados_grupos_v3"(
...
-- Permisos
GRANT ALL ON FUNCTION "public"."get_act_aliados_grupos_v3"("p_mes" "text", "p_region" "text", "p_estado" "text", "p_aliado" "text", "p_sucursal" "text", "p_page" integer, "p_page_size" integer, "p_sort_column" "text", "p_sort_direction" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."get_act_aliados_grupos_v3"("p_mes" "text", "p_region" "text", "p_estado" "text", "p_aliado" "text", "p_sucursal" "text", "p_page" integer, "p_page_size" integer, "p_sort_column" "text", "p_sort_direction" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_act_aliados_grupos_v3"("p_mes" "text", "p_region" "text", "p_estado" "text", "p_aliado" "text", "p_sucursal" "text", "p_page" integer, "p_page_size" integer, "p_sort_column" "text", "p_sort_direction" "text") TO "service_role";
