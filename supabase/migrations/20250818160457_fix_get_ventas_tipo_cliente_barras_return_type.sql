-- Corregir función RPC para obtener ventas por tipo de cliente (gráfico de barras)
-- Corregir tipo de retorno para TIPOCLIENTE de text a character varying

-- Eliminar función existente primero
DROP FUNCTION IF EXISTS get_ventas_tipo_cliente_barras(text[], text[], text[], text[], text[], text[], text[], text[], numeric[], text[], text[]);

-- Recrear función con tipo correcto
